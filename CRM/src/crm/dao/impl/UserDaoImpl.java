...
import crm.utils.XmlUtils;
//2
public class UserDaoImpl implements UserDao {
	/* (non-Javadoc)
	 * @see crm.dao.impl.UserDao#add(crm.domain.User)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see crm.dao.impl.UserDao#find(java.lang.String, java.lang.String)
	 */
	@Override
	...
	//查找注册的用户是否在数据库中存在
	/* (non-Javadoc)
	 * @see crm.dao.impl.UserDao#find(java.lang.String)
	 */
	@Override
